...
exports.subscribe = function() {
  var args, base, cb, i, service, type;
  ...
  return socket.emit.apply(socket, ['subscribe', service, type].concat(slice.call(args)));
};
...
exports.subscribe$ = function() {
  var args, service, type;
  service = arguments[0], type = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
  return Kefir.stream(function(emitter) {
    return exports.subscribe.apply(exports, [service, type].concat(slice.call(args), [function(result) {
